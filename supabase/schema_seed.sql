...
VALUES
  ...
  (5, '細姑', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (10, 'Patrick So', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (11, '大姑', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (12, 'Christine Yuen', 'Uni Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (13, 'Michael Chan', 'Uni Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (16, 'Lee Cheuk Lin Charlia', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (17, 'Mike Pang Sukji', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (18, 'Lin Sin Ting Carol', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (19, 'Lau Ka Wai Joey', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (20, 'Mok Pui Lam Meva', 'Secondary School Friends', '女方', 'Pending', 'Pending', NULLIF('',''), FALSE, NULL),
  (21, 'Yu Hueng Ying Jennifer', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (22, 'Clare Luk', 'Secondary School Friends', '女方', 'Pending', 'Pending', NULLIF('',''), FALSE, NULL),
  (23, 'Ho Wing Tung Toby', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (24, 'Wong Wang Chung Venus', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (25, 'Ho Shuk Ching Ellie', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (26, 'Phoebe Lai', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (27, 'Lee Suet Yee Alison', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (28, 'Leung Kwan Sara', 'Secondary School Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (29, 'Flora and Poting', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('other',''), FALSE, NULL),
  (30, 'Flora and Poting ', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (31, 'Mr & Mrs Mark Robson', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (32, 'Mr & Mrs Mark Robson', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (33, 'Evelyn Yau', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (34, 'Joanne Chan', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('other',''), FALSE, NULL),
  ...
  (38, 'Rachel Lam', 'Christy Ex-Colleague', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (44, 'James, Tracy and Family', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (45, 'James, Tracy and Family', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (46, 'James, Tracy and Family', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), TRUE, NULL),
  (47, 'James, Tracy and Family', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), TRUE, NULL),
  ...
  (54, 'Esther Tam', 'Christy Church Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (55, 'Rosita Yung', 'Christy Church Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (72, 'Shirely Cheung', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (73, 'Yick Ming Lok', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (74, 'Yick Kin Wah', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (75, 'Phoneix Lee', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (76, 'William Tsang', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (82, 'Agnes Yau', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (83, 'Mrs Yau', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (84, 'Teresa Yau', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (85, 'Andrew Wong', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (86, 'Biddy & Mrs Kwok', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (87, 'Biddy & Mrs Kwok', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (89, 'Portia Young', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (95, 'Candy Mak and Family', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (96, 'Candy Mak and Family', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (97, 'Chris Mak and Family', 'Christy Dad Friends', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (117, 'Nice Chan', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (118, 'Adrian Lake', 'Christy Relatives', '女方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (127, 'Ben Li', 'Mitch Family', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (128, 'Toby Li', 'Mitch Family', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (134, 'Austin Lau', 'Uni Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (137, 'Aggie Chan', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (138, 'Juddy Chu', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (139, 'SoSo', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (140, 'Vivian Lou', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (141, 'Anthony Ma', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (147, 'Howard Chu', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (148, 'Roku Inui', 'UK Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (169, 'Winky Ho', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (170, 'Leo Lee', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (171, 'Wini Yung', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (172, 'Peter Liu', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (173, 'CanCan Li', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (174, 'Erica Wong', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (175, 'Sam', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (176, 'Kelly Chui', 'Foodie Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (177, 'Billy Lee', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (178, 'Gina Leung', 'HK Macau Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (179, 'Takaya Wong', 'UK Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (180, 'Ella Cheung', 'UK Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (181, 'Ise Jun', 'Mitch Work Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  (182, 'Takenori Fuji', 'Mitch Work Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (188, 'Gentle Tam', 'Mitch Work Friends', '男方', 'Yes', 'Yes', NULLIF('',''), FALSE, NULL),
  ...
  (201, 'Mitch Mom''s Friend 1', 'Mitch Mom Friends', '男方', 'Pending', 'Pending', NULLIF('',''), FALSE, NULL),
  (202, 'Mitch Mom''s Friend 2', 'Mitch Mom Friends', '男方', 'Pending', 'Pending', NULLIF('',''), FALSE, NULL)
...
-- Set only when an admin records a guest's answer by hand. NULL means
-- rsvp_status is either a website reply (mirrored by submit_rsvp) or an
-- un-actioned spreadsheet estimate — see 2026-08-25_rsvp_confirmed_at.sql.
...
-- 27. attendance_truth → who has actually answered, and by which route.
--     Read this, never guests.rsvp_status, for a real headcount.
